...
public class LayoutHelper {
    ...
    /**
     * Convenience method which combines {@link #getDimensionFromResource(Context, int)} and {@link #dpToPixel(Context, float)}
     *
     * @param context    A {@link Context} used to get the displays density factor
    ...
    /**
     * Generates a unique id for a dynamically created {@link View}
     *
     * @return a unique id
     */
    ...
    /**
     * Uses a {@link Context} to return the density factory of the current display
     *
     * @param context The {@link Context} used to retrieve the density factor
    ...
    /**
     * Populates a {@link ViewGroup} from an {@link Adapter}
     *
     * @param viewGroup The {@link ViewGroup} which will be populated
     * @param adapter   The {@link Adapter} which supplies the {@link View Views} to the {@link ViewGroup}
     */
    ...
    /**
     * Equally distributes a fixed amount of {@link View Views} from an {@link Adapter}
     * in a {@link LinearLayout}. If the {@link Adapter} cannot supply enough {@link View Views}
     * to fill the {@link LinearLayout} then transparent empty dummy {@link View Views} will be
     * used instead. These dummy {@link View Views} will be automatically replaced if a {@link View}
     * is available by the next time {@link #distributeViews(LinearLayout, Adapter, int)} is called.
     *
     * @param layout    The {@link LinearLayout} which will be populated
     * @param adapter   The {@link Adapter} which supplies the {@link View Views} to the {@link LinearLayout}
     * @param viewCount The amount of {@link View Views} which will be displayed in the {@link LinearLayout}.
     */
     ...
     * @param adapter   The {@link Adapter} which supplies the {@link View Views} to the {@link LinearLayout}
     * @param viewCount The amount of {@link View Views} which will be displayed in the {@link LinearLayout}.
     * @param spacing   Specifies a margin between each {@link View} in the {@link LinearLayout}
     */
